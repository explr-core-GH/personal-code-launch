...
const btnGhost: React.CSSProperties = { background: "transparent", color: "#475569", border: "none", padding: "8px 10px", borderRadius: 6, cursor: "pointer", fontWeight: 600, fontSize: 13, fontFamily: "inherit", display: "inline-flex", alignItems: "center" };
