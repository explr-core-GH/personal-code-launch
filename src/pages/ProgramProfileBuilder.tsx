...
const inputStyle = { width: "100%", padding: "7px 10px", fontSize: 13, border: "1px solid #e2e8f0", borderRadius: 6, fontFamily: "inherit", color: "#1a2332", background: "white", boxSizing: "border-box", outline: "none" };
const btnPrimary = { background: "#00694e", color: "white", border: "none", padding: "8px 14px", borderRadius: 6, cursor: "pointer", fontWeight: 600, fontSize: 13, fontFamily: "inherit", display: "inline-flex", alignItems: "center" };
const btnSecondary = { background: "white", color: "#1a2332", border: "1px solid #e2e8f0", padding: "8px 14px", borderRadius: 6, cursor: "pointer", fontWeight: 600, fontSize: 13, fontFamily: "inherit", display: "inline-flex", alignItems: "center" };
const btnGhost = { background: "transparent", color: "#475569", border: "none", padding: "8px 10px", borderRadius: 6, cursor: "pointer", fontWeight: 600, fontSize: 13, fontFamily: "inherit", display: "inline-flex", alignItems: "center" };
const btnIcon = { background: "transparent", color: "#64748b", border: "none", padding: 6, borderRadius: 6, cursor: "pointer", display: "inline-flex", alignItems: "center", justifyContent: "center" };
const modalBackdrop = { position: "fixed", inset: 0, background: "rgba(15,23,42,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50, padding: 20 };
const modalBox = { background: "white", borderRadius: 12, width: "100%", maxWidth: 600, maxHeight: "85vh", display: "flex", flexDirection: "column", boxShadow: "0 20px 60px rgba(0,0,0,0.2)" };
